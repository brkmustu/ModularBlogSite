...
using SurveyModule;
using SurveyModule.System.SeedSampleData;
using CoreModule.Web.Swagger;
using Microsoft.OpenApi.Models;
using CoreModule.Web.Codes;
using SurveyModule.Infrastructure;
using SurveyModule.System.Permissions;
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        var baseModuleContext = scopedServices.GetRequiredService<SurveyModuleDbContext>();
